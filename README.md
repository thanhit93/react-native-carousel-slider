...
[![npm](https://img.shields.io/npm/v/react-native-carousel-slider-layout.svg?style=flat-square)](https://www.npmjs.com/package/react-native-carousel-slider-layout)
[![npm](https://img.shields.io/npm/dm/react-native-snap-carousel.svg?style=flat-square&colorB=007ec6)](https://www.npmjs.com/package/react-native-carousel-slider-layout)
...
```bash
$ npm install --save react-native-carousel-slider-layout
```
...
```javascript
import Carousel from 'react-native-carousel-slider-layout';
